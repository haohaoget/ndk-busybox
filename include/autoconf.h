...
#define CONFIG_IPMONITOR 1
#define ENABLE_IPMONITOR 1
#ifdef MAKE_SUID
# define IF_IPMONITOR(...) __VA_ARGS__ "CONFIG_IPMONITOR"
#else
# define IF_IPMONITOR(...) __VA_ARGS__
#endif
#define IF_NOT_IPMONITOR(...)
#define CONFIG_FEATURE_IP_MONITOR 1
#define ENABLE_FEATURE_IP_MONITOR 1
#ifdef MAKE_SUID
# define IF_FEATURE_IP_MONITOR(...) __VA_ARGS__ "CONFIG_FEATURE_IP_MONITOR"
#else
# define IF_FEATURE_IP_MONITOR(...) __VA_ARGS__
#endif
#define IF_NOT_FEATURE_IP_MONITOR(...)
